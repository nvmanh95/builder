...
set CLASSPATH=%APP_HOME%\lib\web.jar;%APP_HOME%\lib\services.jar;%APP_HOME%\lib\utils.jar;%APP_HOME%\lib\servlet-api-2.5.jar

@rem Execute web
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %WEB_OPTS%  -classpath "%CLASSPATH%" com.builders.web.HelloServlet %CMD_LINE_ARGS%
